  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="School Management - Uniting Students, Parents, and Educators in a Comprehensive Digital Environment. Manage Academics, Attendance, Schedules, and More with Ease and Efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`School Management - Uniting Students, Parents, and Educators in a Comprehensive Digital Environment. Manage Academics, Attendance, Schedules, and More with Ease and Efficiency.`}
            </Text>
            <Box
