...
import { getRenamedclassById } from 'apiSdk/renamedclasses';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Renamedclass Details
                  </Text>
                </Box>
                {hasAccess('renamedclass', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/renamedclasses/edit/${id}`} passHref legacyBehavior>
                    <Button
