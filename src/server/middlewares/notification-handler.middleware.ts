...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'academic_year.create': {
    ...
    key: 'academic-year-created',
    tenantPath: ['organization', 'academic_year'],
    userPath: [],
  },
  'attendance.create': {
    roles: ['admin', 'teacher', 'student', 'parent'],
    key: 'attendance-taken',
    tenantPath: ['organization', 'academic_year', 'class', 'attendance'],
    userPath: [],
  },
  'assignment.create': {
    roles: ['admin', 'teacher', 'student', 'parent'],
    key: 'new-assignment-posted',
    tenantPath: ['organization', 'academic_year', 'class', 'assignment'],
    userPath: [],
  },
};
